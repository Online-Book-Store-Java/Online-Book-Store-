...
footer {
 ...
 .submenu {
    ...
    <body>
        <header>
            <a href="Homepage.jsp"><img src="images/l1.png" alt="Logo" style=" height: 50 ;width: 150px;"></a>
            ...
            <ul>
                ...
                <li><a href="#" onclick="toggleSubmenu()">Browse Books</a>
                    <ul id="submenu" class="submenu">
                        <li><a href="Science_Fiction.jsp">Scientific Fiction</a></li>
    ...
    <center>
        ...
        <footer>
            <p> All rights reserved &COPY;2024 Reader's Cafe Online Bookstore</p>
        </footer>
  </body>
</html>
