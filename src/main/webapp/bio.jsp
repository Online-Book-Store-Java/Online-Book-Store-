...
<head>
<meta charset="UTF-8">
<title>Biography and Memoir</title>
...
<div class="container">
<div class="card-header my-3">Biography and Memoir</div>
<div class="row">

<%
if (!products.isEmpty()) {
  for (product p : products) {
    if (p.getCategory().equals("Biography and Memoir")) { // Check for "Scientific Fiction" category
%>
